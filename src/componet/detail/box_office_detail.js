...
class Detail extends React.Component {
    constructor(props) {
        ...
        console.log(id)
        props.service.getBoxOffice(id)
    }

    render() {
        console.log(this.props.service.boxmovie)
        const { id, title, releasedate, director, rate, kind, country, language, time, actor } = this.props.service.boxmovie
        if (!id) {
            return <Empty />
        }
        return <div>
