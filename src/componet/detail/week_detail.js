...
class Detail extends React.Component {
    constructor(props) {
        ...
        console.log(id)
        props.service.getWeekMovie(id)
    }

    render() {
        console.log(this.props.service.weekmovie)
        const { id, title, releasedate, director, rate, kind, country, language, time, actor } = this.props.service.weekmovie
        if (id<0) {
            return <Empty />
        }
        return <div>
